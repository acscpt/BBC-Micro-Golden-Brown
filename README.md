...
- A real-time visualiser that costs two byte-writes per voice per step.
- Direct pokes into screen RAM to set up Teletext colour attributes for the three-voice cursor display.
